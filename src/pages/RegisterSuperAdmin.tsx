...
const RegisterSuperAdmin: React.FC = () => {
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      // Send registration request (password is auto-generated by backend)
      await api.post('/api/auth/register-super-admin', formData);

      // Stop loading state immediately after successful registration
              ...
              <form onSubmit={onSubmit} className="space-y-4">
                ...
                <div className="flex flex-col">
                  <div className="flex items-center gap-2 rounded-lg border border-blue-500/50 bg-blue-500/10 p-3">
                    <span className="material-symbols-outlined text-blue-500" style={{ fontSize: '20px' }}>info</span>
                    <p className="text-sm font-medium text-blue-500">
                      A secure password will be auto-generated and sent to your email.
                    </p>
                  </div>
                </div>
